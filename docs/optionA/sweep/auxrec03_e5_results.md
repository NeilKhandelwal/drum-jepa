# E5 content probes — drumjepa_v1_auxrec03 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.649 | 0.669 |
| drumjepa | linear | validation | heldout_kits | 0.479 | 0.502 |
| drumjepa | linear | test | train_kits | 0.663 [0.639, 0.677] | 0.673 |
| drumjepa | linear | test | heldout_kits | 0.494 [0.460, 0.507] | 0.504 |
| drumjepa | mlp | validation | train_kits | 0.641 | 0.653 |
| drumjepa | mlp | validation | heldout_kits | 0.471 | 0.482 |
| drumjepa | mlp | test | train_kits | 0.653 [0.629, 0.662] | 0.657 |
| drumjepa | mlp | test | heldout_kits | 0.480 [0.446, 0.494] | 0.483 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.901 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.824 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.868 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.418 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.706 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.707 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.849 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.861 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.539 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.492 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.415 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.274 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.875 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.554 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.636 | 0.633 |
| drumjepa | tokens | 0.653 | 0.652 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 16.802 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 18.504 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 16.681 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 17.987 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 16.383 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 18.686 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 16.194 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 18.383 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 37.769 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 41.976 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 38.273 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 41.675 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 35.973 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 40.914 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 37.061 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 41.099 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.167 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.124 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.146 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.176 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.188 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.153 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.168 | 0.179 | 125440 |
...
Velocity MAE is also 0.1313 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.663 [0.639, 0.677].
Against the controls the trained encoder beats both: random 0.365, raw_mel 0.583, trivial class-prior baseline 0.130; the best representation overall is drumjepa at 0.663, so the same warning as E3 applies — a probe only counts when it beats the spectrum it was computed from.
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: kick, ride, rimshot score highest and crash2, crash1, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.633 to 0.652 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 16.7 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 38.3 ms against 60.3 ms, and the hi-hat pedal position is 0.124 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.494 against 0.663, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
