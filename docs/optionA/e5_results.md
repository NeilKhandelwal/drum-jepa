# E5 content probes — drumjepa_v1_auxrec (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.612 | 0.638 |
| drumjepa | linear | validation | heldout_kits | 0.474 | 0.502 |
| drumjepa | linear | test | train_kits | 0.625 [0.599, 0.646] | 0.635 |
| drumjepa | linear | test | heldout_kits | 0.484 [0.450, 0.498] | 0.499 |
| drumjepa | mlp | validation | train_kits | 0.618 | 0.629 |
| drumjepa | mlp | validation | heldout_kits | 0.481 | 0.491 |
| drumjepa | mlp | test | train_kits | 0.621 [0.598, 0.634] | 0.624 |
| drumjepa | mlp | test | heldout_kits | 0.480 [0.446, 0.493] | 0.481 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.884 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.786 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.863 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.324 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.670 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.624 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.819 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.839 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.499 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.433 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.393 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.266 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.853 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.500 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.590 | 0.614 |
| drumjepa | tokens | 0.602 | 0.634 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 18.375 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 19.918 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 18.075 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 19.270 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 17.901 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 19.646 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 17.682 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 19.348 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 39.956 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 43.787 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 40.446 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 43.691 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 36.822 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 40.837 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 37.897 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 41.525 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.150 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.162 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.127 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.143 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.174 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.185 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.157 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.170 | 0.179 | 125440 |
...
Velocity MAE is also 0.1423 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.625 [0.599, 0.646].
Against the controls the trained encoder beats both: random 0.365, raw_mel 0.583, trivial class-prior baseline 0.130; the best representation overall is drumjepa at 0.625, so the same warning as E3 applies — a probe only counts when it beats the spectrum it was computed from.
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: kick, rimshot, ride score highest and crash2, crossstick, crash1 lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.614 to 0.634 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 18.1 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 40.4 ms against 60.3 ms, and the hi-hat pedal position is 0.127 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.484 against 0.625, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
