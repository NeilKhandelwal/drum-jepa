# E5 content probes — drumjepa_v1_auxrec01_s2 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.667 | 0.696 |
| drumjepa | linear | validation | heldout_kits | 0.310 | 0.337 |
| drumjepa | linear | test | train_kits | 0.664 [0.641, 0.676] | 0.689 |
| drumjepa | linear | test | heldout_kits | 0.304 [0.265, 0.324] | 0.328 |
| drumjepa | mlp | validation | train_kits | 0.677 | 0.693 |
| drumjepa | mlp | validation | heldout_kits | 0.353 | 0.374 |
| drumjepa | mlp | test | train_kits | 0.671 [0.651, 0.681] | 0.683 |
| drumjepa | mlp | test | heldout_kits | 0.343 [0.304, 0.360] | 0.362 |
...
| snare | 0.3792 | 0.835 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.871 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.437 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.751 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.738 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.874 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.849 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.514 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.488 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.355 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.218 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.875 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.579 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.644 | 0.650 |
| drumjepa | tokens | 0.656 | 0.659 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 15.549 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 30.809 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 15.862 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 32.347 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 13.701 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 32.533 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 13.542 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 32.470 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 39.271 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 62.376 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 39.292 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 61.648 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 34.335 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 56.167 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 35.075 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 54.298 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.148 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.204 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.124 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.196 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.148 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.195 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.122 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.179 | 0.179 | 125440 |
...
Velocity MAE is also 0.1249 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.664 [0.641, 0.676].
Against the controls the trained encoder beats both: random 0.365, raw_mel 0.583, trivial class-prior baseline 0.130; the best representation overall is drumjepa at 0.664, so the same warning as E3 applies — a probe only counts when it beats the spectrum it was computed from.
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: kick, ride, tom_lo score highest and crash2, crash1, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.650 to 0.659 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 15.9 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 39.3 ms against 60.3 ms, and the hi-hat pedal position is 0.124 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.304 against 0.664, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
