# E5 content probes — drumjepa_v1_s2 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.255 | 0.403 |
| drumjepa | linear | validation | heldout_kits | 0.210 | 0.365 |
| drumjepa | linear | test | train_kits | 0.263 [0.243, 0.275] | 0.395 |
| drumjepa | linear | test | heldout_kits | 0.209 [0.189, 0.218] | 0.355 |
| drumjepa | mlp | validation | train_kits | 0.295 | 0.401 |
| drumjepa | mlp | validation | heldout_kits | 0.241 | 0.351 |
| drumjepa | mlp | test | train_kits | 0.307 [0.286, 0.319] | 0.399 |
| drumjepa | mlp | test | heldout_kits | 0.240 [0.217, 0.251] | 0.334 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.485 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.524 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.589 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.009 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.115 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.017 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.061 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.710 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.072 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.217 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.045 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.009 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.735 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.098 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.272 | 0.267 |
| drumjepa | tokens | 0.506 | 0.519 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 19.652 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 21.158 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 18.958 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 19.990 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 20.927 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 24.727 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 19.947 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 23.204 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 52.742 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 53.681 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 51.059 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 51.951 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 50.849 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 54.506 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 49.554 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 53.369 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.172 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.193 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.145 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.180 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.182 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.200 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.154 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.180 | 0.179 | 125440 |
...
Velocity MAE is also 0.1493 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.263 [0.243, 0.275].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: ride, hh_closed, rimshot score highest and crossstick, crash2, tom_mid lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.267 to 0.519 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 19.0 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 51.1 ms against 60.3 ms, and the hi-hat pedal position is 0.145 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.209 against 0.263, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
