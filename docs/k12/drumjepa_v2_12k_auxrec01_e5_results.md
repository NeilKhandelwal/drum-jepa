# E5 content probes — drumjepa_v2_12k_auxrec01 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.643 | 0.673 |
| drumjepa | linear | validation | heldout_kits | 0.318 | 0.357 |
| drumjepa | linear | test | train_kits | 0.648 [0.627, 0.664] | 0.676 |
| drumjepa | linear | test | heldout_kits | 0.316 [0.280, 0.333] | 0.353 |
| drumjepa | mlp | validation | train_kits | 0.636 | 0.665 |
| drumjepa | mlp | validation | heldout_kits | 0.400 | 0.429 |
| drumjepa | mlp | test | train_kits | 0.646 [0.625, 0.663] | 0.667 |
| drumjepa | mlp | test | heldout_kits | 0.403 [0.366, 0.416] | 0.422 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.900 | 0.725 | 0.719 | 0.399 |
| snare | 0.3754 | 0.827 | 0.538 | 0.706 | 0.356 |
| rimshot | 0.1086 | 0.868 | 0.632 | 0.736 | 0.105 |
| crossstick | 0.0627 | 0.465 | 0.076 | 0.274 | 0.051 |
| tom_hi | 0.0473 | 0.750 | 0.371 | 0.602 | 0.038 |
| tom_mid | 0.0246 | 0.560 | 0.162 | 0.558 | 0.025 |
| tom_lo | 0.0506 | 0.827 | 0.374 | 0.629 | 0.050 |
| hh_closed | 0.2720 | 0.854 | 0.718 | 0.762 | 0.338 |
| hh_open | 0.0626 | 0.519 | 0.119 | 0.337 | 0.058 |
| hh_pedal | 0.2602 | 0.476 | 0.321 | 0.287 | 0.215 |
| crash1 | 0.0187 | 0.422 | 0.030 | 0.059 | 0.014 |
| crash2 | 0.0086 | 0.208 | 0.013 | 0.134 | 0.004 |
| ride | 0.2243 | 0.874 | 0.630 | 0.738 | 0.158 |
| ride_bell | 0.0363 | 0.529 | 0.091 | 0.340 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.615 | 0.629 |
| drumjepa | tokens | 0.632 | 0.644 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 16.804 | 24.566 | 379968 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 34.530 | 24.566 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 16.897 | 24.513 | 341352 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 35.257 | 24.513 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 15.482 | 24.566 | 379968 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 33.067 | 24.566 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 15.056 | 24.513 | 341352 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 33.262 | 24.513 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 38.872 | 63.256 | 379968 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 64.058 | 63.256 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 38.409 | 60.279 | 341352 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 64.861 | 60.279 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 35.515 | 63.256 | 379968 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 55.558 | 63.256 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 35.736 | 60.279 | 341352 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 54.898 | 60.279 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.147 | 0.194 | 195264 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.199 | 0.194 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.123 | 0.181 | 188160 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.188 | 0.181 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.150 | 0.194 | 195264 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.187 | 0.194 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.124 | 0.181 | 188160 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.172 | 0.181 | 125440 |
...
Velocity MAE is also 0.1330 (drumjepa), 0.1407 (random), 0.1368 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.648 [0.627, 0.664].
Against the controls the trained encoder beats both: random 0.343, raw_mel 0.491, trivial class-prior baseline 0.131; the best representation overall is drumjepa at 0.648, so the same warning as E3 applies — a probe only counts when it beats the spectrum it was computed from.
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: kick, ride, rimshot score highest and crash2, crash1, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.629 to 0.644 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 16.9 MIDI units against 24.5 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 38.4 ms against 60.3 ms, and the hi-hat pedal position is 0.123 against 0.181 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.316 against 0.648, random 0.332 against 0.343 — but cost the raw log-mel most of its lead (0.284 against 0.491), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
