# E5 content probes — drumjepa_v1_e40 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.217 | 0.344 |
| drumjepa | linear | validation | heldout_kits | 0.172 | 0.337 |
| drumjepa | linear | test | train_kits | 0.223 [0.207, 0.233] | 0.345 |
| drumjepa | linear | test | heldout_kits | 0.176 [0.165, 0.183] | 0.339 |
| drumjepa | mlp | validation | train_kits | 0.255 | 0.357 |
| drumjepa | mlp | validation | heldout_kits | 0.218 | 0.328 |
| drumjepa | mlp | test | train_kits | 0.275 [0.258, 0.286] | 0.366 |
| drumjepa | mlp | test | heldout_kits | 0.228 [0.214, 0.236] | 0.333 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.479 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.518 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.550 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.005 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.014 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.001 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.002 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.673 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.006 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.192 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.028 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.000 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.646 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.010 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.228 | 0.236 |
| drumjepa | tokens | 0.407 | 0.450 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 20.174 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 20.953 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 19.449 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 19.885 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 21.711 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 23.945 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 20.836 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 22.720 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 53.899 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 54.128 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 52.259 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 52.416 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 51.917 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 53.391 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 50.569 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 51.888 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.176 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.186 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.149 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.170 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.189 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.204 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.164 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.188 | 0.179 | 125440 |
...
Velocity MAE is also 0.1531 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.223 [0.207, 0.233].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: hh_closed, ride, rimshot score highest and crash2, tom_mid, tom_lo lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.236 to 0.450 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 19.4 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 52.3 ms against 60.3 ms, and the hi-hat pedal position is 0.149 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.176 against 0.223, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
