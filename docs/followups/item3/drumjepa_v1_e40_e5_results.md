# E5 content probes — drumjepa_v1_e40 (epoch 39) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.189 | 0.324 |
| drumjepa | linear | validation | heldout_kits | 0.152 | 0.312 |
| drumjepa | linear | test | train_kits | 0.197 [0.181, 0.206] | 0.317 |
| drumjepa | linear | test | heldout_kits | 0.162 [0.143, 0.174] | 0.308 |
| drumjepa | mlp | validation | train_kits | 0.244 | 0.349 |
| drumjepa | mlp | validation | heldout_kits | 0.191 | 0.323 |
| drumjepa | mlp | test | train_kits | 0.258 [0.241, 0.269] | 0.351 |
| drumjepa | mlp | test | heldout_kits | 0.198 [0.179, 0.209] | 0.331 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.323 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.456 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.475 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.000 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.005 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.000 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.000 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.658 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.000 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.140 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.027 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.000 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.671 | 0.635 | 0.782 | 0.159 |
...
|---|---|---|---|
| drumjepa | pooled | 0.200 | 0.205 |
| drumjepa | tokens | 0.395 | 0.419 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 21.077 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 21.841 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 20.458 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 21.005 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 21.586 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 24.222 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 20.683 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 22.645 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 56.822 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 57.265 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 54.857 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 55.500 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 54.510 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 56.247 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 52.527 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 54.628 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.178 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.188 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.152 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.174 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.182 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.192 | 0.193 | 130176 |
...
Velocity MAE is also 0.1611 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.197 [0.181, 0.206].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: ride, hh_closed, rimshot score highest and tom_mid, crash2, ride_bell lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.205 to 0.419 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 20.5 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 54.9 ms against 60.3 ms, and the hi-hat pedal position is 0.152 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.162 against 0.197, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
