# Readout prediction metric — drumjepa_v1_auxrec01_s1 (epoch 19, test split, 6 train kits)
...
|---|---|---|---|---|
| predicted | 128000 | 0.646 [0.619, 0.660] | 0.25 | 0.997 |
| ceiling | 32000 | 0.648 [0.624, 0.660] | 0.30 | 0.996 |
| full_mask | 32000 | 0.621 [0.596, 0.637] | 0.15 | 0.996 |

Onset F1 of the predicted grid as a fraction of the ceiling: **0.996**; kit accuracy as a fraction of the ceiling: 1.001.

Restricted to the 117233 time steps where more than 50% of the 16 frequency tokens were predicted, the predicted grid scores 0.648 against a ceiling of 0.651 on the same steps (ratio 0.995).
...
- For reference, the E2-style masked prediction error on the same transitions is 0.0376, and the teacher's mean per-dim variance is 1.9641 (normalized error 0.0191).
...
| snare | 0.788 | 0.783 |
| rimshot | 0.879 | 0.857 |
| crossstick | 0.361 | 0.401 |
| tom_hi | 0.708 | 0.722 |
| tom_mid | 0.645 | 0.688 |
| tom_lo | 0.808 | 0.819 |
| hh_closed | 0.829 | 0.833 |
| hh_open | 0.523 | 0.506 |
| hh_pedal | 0.518 | 0.516 |
| crash1 | 0.361 | 0.344 |
| crash2 | 0.271 | 0.294 |
| ride | 0.878 | 0.871 |
| ride_bell | 0.550 | 0.540 |
