# E5 content probes — drumjepa_v1_vcrec_s2 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.131 | 0.260 |
| drumjepa | linear | validation | heldout_kits | 0.135 | 0.263 |
| drumjepa | linear | test | train_kits | 0.148 [0.135, 0.158] | 0.242 |
| drumjepa | linear | test | heldout_kits | 0.154 [0.140, 0.164] | 0.244 |
| drumjepa | mlp | validation | train_kits | 0.193 | 0.273 |
| drumjepa | mlp | validation | heldout_kits | 0.196 | 0.274 |
| drumjepa | mlp | test | train_kits | 0.214 [0.197, 0.224] | 0.269 |
| drumjepa | mlp | test | heldout_kits | 0.218 [0.201, 0.228] | 0.273 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.311 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.374 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.254 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.000 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.000 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.000 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.000 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.498 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.000 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.143 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.000 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.000 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.500 | 0.635 | 0.782 | 0.159 |
...
|---|---|---|---|
| drumjepa | pooled | 0.142 | 0.152 |
| drumjepa | tokens | 0.267 | 0.288 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 23.135 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 23.003 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 22.121 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 21.983 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 26.126 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 26.212 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 25.602 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 25.805 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 57.057 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 56.819 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 53.690 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 53.300 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 60.151 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 60.077 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 58.181 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 58.318 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.182 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.164 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.163 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.201 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.198 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.176 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.175 | 0.179 | 125440 |
...
Velocity MAE is also 0.1742 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.148 [0.135, 0.158].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: ride, hh_closed, snare score highest and crossstick, tom_hi, tom_mid lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.152 to 0.288 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 22.1 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 53.7 ms against 60.3 ms, and the hi-hat pedal position is 0.164 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.154 against 0.148, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
