# E5 content probes — drumjepa_v1_melrec_s2 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.477 | 0.562 |
| drumjepa | linear | validation | heldout_kits | 0.245 | 0.277 |
| drumjepa | linear | test | train_kits | 0.505 [0.474, 0.523] | 0.557 |
| drumjepa | linear | test | heldout_kits | 0.248 [0.217, 0.262] | 0.276 |
| drumjepa | mlp | validation | train_kits | 0.580 | 0.622 |
| drumjepa | mlp | validation | heldout_kits | 0.241 | 0.277 |
| drumjepa | mlp | test | train_kits | 0.602 [0.573, 0.623] | 0.623 |
| drumjepa | mlp | test | heldout_kits | 0.249 [0.214, 0.265] | 0.278 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.814 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.704 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.752 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.200 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.555 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.517 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.642 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.799 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.274 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.405 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.113 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.186 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.825 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.285 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.459 | 0.488 |
| drumjepa | tokens | 0.600 | 0.602 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 15.955 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 31.486 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 16.213 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 31.456 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 13.558 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 33.496 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 13.620 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 31.824 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 49.972 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 82.651 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 48.285 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 78.461 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 44.846 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 82.025 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 44.767 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 79.987 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.160 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.216 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.135 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.194 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.153 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.219 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.126 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.205 | 0.179 | 125440 |
...
Velocity MAE is also 0.1277 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.505 [0.474, 0.523].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: ride, kick, hh_closed score highest and crash1, crash2, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.488 to 0.602 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 16.2 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 48.3 ms against 60.3 ms, and the hi-hat pedal position is 0.135 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.248 against 0.505, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
