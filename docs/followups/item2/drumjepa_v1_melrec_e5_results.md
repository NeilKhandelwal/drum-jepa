# E5 content probes — drumjepa_v1_melrec (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.494 | 0.576 |
| drumjepa | linear | validation | heldout_kits | 0.261 | 0.287 |
| drumjepa | linear | test | train_kits | 0.522 [0.493, 0.540] | 0.571 |
| drumjepa | linear | test | heldout_kits | 0.250 [0.223, 0.263] | 0.273 |
| drumjepa | mlp | validation | train_kits | 0.603 | 0.640 |
| drumjepa | mlp | validation | heldout_kits | 0.261 | 0.287 |
| drumjepa | mlp | test | train_kits | 0.618 [0.591, 0.638] | 0.640 |
| drumjepa | mlp | test | heldout_kits | 0.257 [0.224, 0.275] | 0.283 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.824 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.720 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.767 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.246 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.607 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.557 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.684 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.791 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.290 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.398 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.119 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.143 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.824 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.338 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.466 | 0.506 |
| drumjepa | tokens | 0.620 | 0.634 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 15.648 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 28.814 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 15.838 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 29.737 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 13.174 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 30.273 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 13.167 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 29.996 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 49.404 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 75.940 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 47.763 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 74.265 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 43.789 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 77.337 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 43.676 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 76.650 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.161 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.209 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.133 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.189 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.155 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.204 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.126 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.191 | 0.179 | 125440 |
...
Velocity MAE is also 0.1247 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.522 [0.493, 0.540].
...
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: kick, ride, hh_closed score highest and crash1, crash2, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.506 to 0.634 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 15.8 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 47.8 ms against 60.3 ms, and the hi-hat pedal position is 0.133 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.250 against 0.522, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
