# E5 content probes — drumjepa_v1_melrec_s1 (epoch 19) vs no AO-JEPA
...
|---|---|---|---|---|---|
| drumjepa | linear | validation | train_kits | 0.466 | 0.554 |
| drumjepa | linear | validation | heldout_kits | 0.265 | 0.291 |
| drumjepa | linear | test | train_kits | 0.500 [0.466, 0.516] | 0.553 |
| drumjepa | linear | test | heldout_kits | 0.263 [0.234, 0.278] | 0.285 |
| drumjepa | mlp | validation | train_kits | 0.588 | 0.622 |
| drumjepa | mlp | validation | heldout_kits | 0.264 | 0.286 |
| drumjepa | mlp | test | train_kits | 0.602 [0.573, 0.620] | 0.622 |
| drumjepa | mlp | test | heldout_kits | 0.261 [0.229, 0.278] | 0.281 |
...
|---|---|---|---|---|---|
| kick | 0.4047 | 0.794 | 0.733 | 0.775 | 0.399 |
| snare | 0.3792 | 0.706 | 0.560 | 0.761 | 0.358 |
| rimshot | 0.1073 | 0.719 | 0.705 | 0.837 | 0.104 |
| crossstick | 0.0623 | 0.178 | 0.081 | 0.434 | 0.051 |
| tom_hi | 0.0503 | 0.559 | 0.399 | 0.700 | 0.039 |
| tom_mid | 0.0231 | 0.522 | 0.232 | 0.697 | 0.024 |
| tom_lo | 0.0481 | 0.631 | 0.370 | 0.736 | 0.048 |
| hh_closed | 0.2669 | 0.790 | 0.728 | 0.783 | 0.334 |
| hh_open | 0.0592 | 0.306 | 0.154 | 0.436 | 0.057 |
| hh_pedal | 0.2661 | 0.397 | 0.332 | 0.417 | 0.217 |
| crash1 | 0.0182 | 0.117 | 0.039 | 0.152 | 0.014 |
| crash2 | 0.0078 | 0.139 | 0.000 | 0.173 | 0.003 |
| ride | 0.2289 | 0.834 | 0.635 | 0.782 | 0.159 |
| ride_bell | 0.0369 | 0.308 | 0.145 | 0.486 | 0.017 |
...
|---|---|---|---|
| drumjepa | pooled | 0.462 | 0.482 |
| drumjepa | tokens | 0.589 | 0.595 |
...
|---|---|---|---|---|---|---|---|
| velocity (MIDI vel) | drumjepa | linear | validation | train_kits | 16.359 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | linear | validation | heldout_kits | 29.160 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | linear | test | train_kits | 16.627 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | linear | test | heldout_kits | 28.377 | 24.560 | 227568 |
| velocity (MIDI vel) | drumjepa | mlp | validation | train_kits | 13.844 | 24.605 | 189984 |
| velocity (MIDI vel) | drumjepa | mlp | validation | heldout_kits | 31.138 | 24.605 | 253312 |
| velocity (MIDI vel) | drumjepa | mlp | test | train_kits | 14.043 | 24.560 | 170676 |
| velocity (MIDI vel) | drumjepa | mlp | test | heldout_kits | 29.550 | 24.560 | 227568 |
...
| timing (ms) | drumjepa | linear | validation | train_kits | 50.954 | 63.262 | 189984 |
| timing (ms) | drumjepa | linear | validation | heldout_kits | 73.245 | 63.262 | 253312 |
| timing (ms) | drumjepa | linear | test | train_kits | 48.846 | 60.307 | 170676 |
| timing (ms) | drumjepa | linear | test | heldout_kits | 70.028 | 60.307 | 227568 |
| timing (ms) | drumjepa | mlp | validation | train_kits | 45.612 | 63.262 | 189984 |
| timing (ms) | drumjepa | mlp | validation | heldout_kits | 76.513 | 63.262 | 253312 |
| timing (ms) | drumjepa | mlp | test | train_kits | 45.034 | 60.307 | 170676 |
| timing (ms) | drumjepa | mlp | test | heldout_kits | 74.985 | 60.307 | 227568 |
...
| hihat (CC4/127) | drumjepa | linear | validation | train_kits | 0.166 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | linear | validation | heldout_kits | 0.212 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | linear | test | train_kits | 0.136 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | linear | test | heldout_kits | 0.201 | 0.179 | 125440 |
| hihat (CC4/127) | drumjepa | mlp | validation | train_kits | 0.154 | 0.193 | 97632 |
| hihat (CC4/127) | drumjepa | mlp | validation | heldout_kits | 0.213 | 0.193 | 130176 |
| hihat (CC4/127) | drumjepa | mlp | test | train_kits | 0.123 | 0.179 | 94080 |
| hihat (CC4/127) | drumjepa | mlp | test | heldout_kits | 0.197 | 0.179 | 125440 |
...
Velocity MAE is also 0.1309 (drumjepa), 0.1365 (random), 0.1266 (raw_mel) in velocity/127 units.
...
AO-JEPA was skipped in this run, so the drum-JEPA vs AO-JEPA comparison E5 exists for is not answered here; drum-JEPA's linear onset macro-F1 is 0.500 [0.466, 0.516].
Against the controls the trained encoder beats random: random 0.365, raw_mel 0.583, trivial class-prior baseline 0.130; the best representation overall is raw_mel at 0.583, so the same warning as E3 applies — a probe only counts when it beats the spectrum it was computed from.
What is recoverable is which classes were struck, and only for the frequent, spectrally distinct ones: ride, kick, hh_closed score highest and crash1, crash2, crossstick lowest under the drum-JEPA linear probe, tracking how often the class occurs rather than anything about the model; and mean-pooling the 16 frequency tokens of a step throws content away — concatenating them instead lifts drum-JEPA from 0.482 to 0.595 on the same clips, so every pooled number above is a lower bound.
What is not recoverable is the fine structure of the hit: velocity MAE is 16.6 MIDI units against 24.6 for predicting the per-class training mean, first-onset timing inside the 250 ms step is 48.8 ms against 60.3 ms, and the hi-hat pedal position is 0.136 against 0.179 (CC4/127) — every one of those beats its baseline, but by 10-25%, so the probes read the event far more sharply than its dynamics or its position inside the step.
Held-out kits cost the encoders little — drumjepa 0.263 against 0.500, random 0.320 against 0.365 — but cost the raw log-mel most of its lead (0.277 against 0.583), so the spectrum's advantage is largely kit-specific while what the encoders carry about the action is not.
